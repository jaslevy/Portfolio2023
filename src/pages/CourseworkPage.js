    ...
    <div style={{ maxWidth: "900px", margin: "0 auto" }}>
      <div className="coursework-section">
        ...
        <div className="coursework-list">
          ...
          <button style={{backgroundColor: '#364958'}} class="course-button" onClick={() => window.open('https://courses.cornell.edu/preview_course_nopop.php?catoid=60&coid=1100457', '_blank')}>Algorithms for Applications <strong>(Graduate)</strong></button>
          <button style={{backgroundColor: '#364958'}} class="course-button" onClick={() => window.open('https://classes.cornell.edu/browse/roster/FA22/class/CS/5682', '_blank')}>Human-Computer Interaction <strong>(Graduate)</strong></button>
          ...
          <button style={{backgroundColor: '#55828b'}} class="course-button" onClick={() => window.open('https://classes.cornell.edu/browse/roster/FA22/class/CS/5781', '_blank')}>Machine Learning Engineering <strong>(Graduate)</strong></button>
          <button style={{backgroundColor: '#55828b'}} class="course-button" onClick={() => window.open('https://classes.cornell.edu/browse/roster/SP23/class/CS/5787', '_blank')}>Deep Learning <strong>(Graduate)</strong></button>
          ...
          <button style={{backgroundColor: '#87bba2'}} class="course-button" onClick={() => window.open('https://classes.cornell.edu/browse/roster/FA23/class/TECHIE/5310', '_blank')}>Business Fundamentals <strong>(Graduate)</strong></button>
          <button style={{backgroundColor: '#87bba2'}} class="course-button" onClick={() => window.open('https://classes.cornell.edu/browse/roster/FA23/class/TECH/5900', '_blank')}>Product Studio <strong>(Graduate)</strong></button>
        </div>
      </div>
    </div>
